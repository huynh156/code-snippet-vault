...
> **Sprint số:** 1 / 2
> **Ngày tổ chức Sprint Review:** Thứ Sáu, 28/08/2026 lúc 14:00
...
- Dữ liệu được lưu ngay vào LocalStorage sau khi submit.

### US02 — Syntax Highlighting (5 SP)
- PrismJS render đúng màu cho 8 ngôn ngữ lập trình.
- Hỗ trợ Dark Mode và Light Mode mượt mà.

### US03 — Copy 1-Click (2 SP)
- Sao chép chính xác nội dung code vào Clipboard kèm Toast thông báo.
